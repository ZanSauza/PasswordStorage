...
from app.users.dependencies import get_current_admin_user, change_admin_status
from app.users.models import User
from app.users.schemas import PUserRegister, PUserAuth

router = APIRouter(prefix='/auth', tags=['Auth'])


@router.post("/register/")
async def register_user(user_data: PUserRegister) -> dict:
...
@router.post("/login/")
async def auth_user(response: Response, user_data: PUserAuth):
